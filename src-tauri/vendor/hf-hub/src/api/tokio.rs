...
impl ApiBuilder {
    ...
    pub fn build(self) -> Result<Api, ApiError> {
        ...
        let client = client_builder.default_headers(headers.clone()).build()?;
        ...
        let relative_redirect_client_builder = Client::builder();
        #[cfg(target_os = "windows")]
        let relative_redirect_client_builder = relative_redirect_client_builder
            .http1_only()
            .local_address(IpAddr::V4(Ipv4Addr::UNSPECIFIED));
        let relative_redirect_client = relative_redirect_client_builder
