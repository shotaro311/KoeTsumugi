...
/// and `Dark` force one of the two palettes KoeTsumugi already ships.
#[derive(Serialize, Deserialize, Debug, Clone, Copy, PartialEq, Eq, Type)]
#[serde(rename_all = "snake_case")]
pub enum Theme {
    System,
...
mod tests {
    ...
    fn frozen_v0_9_store_parses_strictly_without_migration() {
        ...
        let stored: serde_json::Value = serde_json::from_str(
            ...
            "debug_mode": false,
            "log_level": 2,
            "custom_words": ["KoeTsumugi", "cjpais"],
    ...
    fn salvage_drops_only_wrong_typed_fields() {
        ...
        assert_eq!(salvaged.sound_theme, default_sound_theme());
        assert_eq!(salvaged.custom_words.len(), 1);
        assert_eq!(salvaged.custom_words[0].output, "handy");
