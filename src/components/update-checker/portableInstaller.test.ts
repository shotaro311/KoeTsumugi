...
const X64_SETUP =
  "https://github.com/shotaro311/KoeTsumugi/releases/download/handy-m-v1.0.4/KoeTsumugi_1.0.4_x64-setup.exe";
const ARM64_SETUP =
  "https://github.com/shotaro311/KoeTsumugi/releases/download/handy-m-v1.0.4/KoeTsumugi_1.0.4_arm64-setup.exe";
...
const manifest = {
  ...
  platforms: {
    ...
    "windows-x86_64-msi": {
      url: "https://github.com/shotaro311/KoeTsumugi/releases/download/handy-m-v1.0.4/KoeTsumugi_1.0.4_x64_en-US.msi",
    },
    "windows-aarch64-nsis": { url: ARM64_SETUP, signature: "…" },
    "darwin-aarch64": {
      url: "https://github.com/shotaro311/KoeTsumugi/releases/download/handy-m-v1.0.4/KoeTsumugi_aarch64.app.tar.gz",
    },
  },
};
