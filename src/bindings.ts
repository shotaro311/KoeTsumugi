...
async updateCustomWords(words: CustomDictionaryEntry[]) : Promise<Result<null, string>> {
    try {
...
export type CustomDictionaryEntry = { output: string; aliases: string[]; use_in_model_prompt: boolean; use_in_post_process: boolean }
